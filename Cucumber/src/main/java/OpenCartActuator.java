...
//        path = "C:\\Users\\User\\Desktop\\ass3sqe\\sqe-hw3\\Selenium\\chromedriver.exe";
        ...
        driver.get("http://localhost/opencartpro/admin");
    ...
    public void answerMultipleChoice(int numOfQuestions){
        Exception e = null;
        while(e == null){
            try{
                // select an answer and continue to next question until there are no more left
                wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[5]/div[5]/div/div[3]/div/section/div[2]/form/div/div[1]/div[2]/div/div[2]/div[1]"))).click();
                driver.findElement(By.xpath("/html/body/div[5]/div[5]/div/div[3]/div/section/div[2]/form/div/div[1]/div[2]/div/div[2]/div[1]/div[5]/input")).click();
                driver.findElement(By.xpath("//*[@id='mod_quiz-next-nav']")).click();
            }catch (Exception caught){
                e = caught;
            }
        }

        // finish attempt and exit quiz review
        finishQuiz();
    ...
    // add multiple choice questions -> start at course page, finish at course page
    ...
    // fill fields for multiple choice question
    // Starts from "Adding a Multiple choice question" page
